...
KBUILD_CFLAGS +=   -DCONFIG_PRODUCT_REALME_TRINKET
KBUILD_CPPFLAGS += -DCONFIG_PRODUCT_REALME_TRINKET
CFLAGS_KERNEL +=   -DCONFIG_PRODUCT_REALME_TRINKET
CFLAGS_MODULE +=   -DCONFIG_PRODUCT_REALME_TRINKET
